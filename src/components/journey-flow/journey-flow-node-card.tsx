...
export const JourneyFlowNodeCard = memo(
  ({ data, id, selected }: NodeProps<JourneyFlowNodeType>) => {
    ...
    // -------------------------------------------------------------------------
    // Annotation variant — informational note generated by AI (dashed border,
    // no handles, no edit affordances, no UI-type badge)
    // -------------------------------------------------------------------------
    ...
    if (data.isAnnotation) {
      return (
        <div
          className={cn(
            'w-[300px] rounded-lg border border-dashed bg-muted/60 px-3 py-2.5',
            selected && 'ring-2 ring-selection'
          )}
        >
          <div className="flex items-center gap-1.5 mb-1.5">
            <Icon name="info" className="h-3.5 w-3.5 text-muted-foreground flex-shrink-0" />

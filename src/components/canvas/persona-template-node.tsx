    ...
    return (
      ...
      >
            ...
            <div className="flex-1 space-y-0.5">
              <div className="flex items-baseline gap-2">
                ...
                <EditableField
                  ...
                  minWidth={80}
                />
                <span className="shrink-0 text-base font-semibold text-white/80">
                  ,
                </span>
                <EditableField
        ...
        >
          <div className="mb-3 flex items-center gap-2">
            <h4
              ...
              style={{ color: "var(--persona-text-medium)" }}
            >
            ...
            {hasEmpathyData && (
              <span
                ...
                style={{
                  backgroundColor: "var(--persona-badge-bg)",
                  color: "var(--persona-badge-text)",
                }}
              >
                From Step 4
              </span>
          ...
          <div className="grid grid-cols-3 gap-2.5">
            {EMPATHY_ZONES.map(({ key, label, Icon, accent, textColor }) => (
              ...
              >
                ...
                {isSkeleton ? (
                  <div
                    className="h-3 w-20 rounded animate-pulse mt-1"
                    style={{ backgroundColor: "currentColor", opacity: 0.15 }}
                  />
                ) : (
                  <EditableField
                    value={semicolonsToParagraphs(
                      data[key as keyof PersonaTemplateData] as
                        | string
                        | undefined,
                    )}
        ...
        <div
          ...
          style={{
            borderBottom: `1px solid ${SAGE.sectionBorder}`,
            color: "var(--persona-text-narrative)",
          }}
        >
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundColor: "var(--persona-quote-bg)",
              borderLeft: `4px solid ${SAGE.avatarBg}`,
            }}
          >
            {isSkeleton ? (
              <div

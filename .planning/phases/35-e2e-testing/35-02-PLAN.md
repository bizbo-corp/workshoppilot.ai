...
<objective>
Create the full E2E workshop walkthrough test that creates a fresh workshop, walks through all 10 steps with real AI (Gemini) interaction, validates responses and step transitions.

Purpose: This is the core E2E test — validates the entire workshop flow end-to-end with real AI, real database, and real browser interactions.
Output: A single comprehensive Playwright spec file testing the happy path through all 10 workshop steps.
</objective>
...
<task type="auto">
  ...
  <action>
    Run the E2E test and fix any bugs discovered during the run. This is the critical test-and-fix loop.

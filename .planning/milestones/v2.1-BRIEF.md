# Milestone Brief: v2.1 Journey Flow + Low-Fidelity Prototype Pipeline

> Source brief for milestone v2.1. Grounded in the existing codebase. Agents planning/executing v2.1 phases should treat the decisions here as locked.
